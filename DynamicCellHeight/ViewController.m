...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<self.dataSource.count; i++) {
        heightX+=[self tableView:self.tableView heightForRowAtIndexPath:[NSIndexPath indexPathForRow:i inSection:0]];
    }
    _tableHeightConstraints.constant = heightX;
    NSLog(@"%f",heightX);
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DynamicTableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:CellIdentifier];
